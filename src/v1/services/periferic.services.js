...
import { createDeleteAllByUserIdQuery, createDeleteByIdQuery, createGetByIdQuery, createInsertQuery, createUpdateQuery } from '../utils/create-dynamic-query.js'

const TABLE_SCHEMA_NAME = 'public.periferic'
